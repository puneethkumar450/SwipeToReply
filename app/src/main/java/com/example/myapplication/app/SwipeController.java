...
public class SwipeController extends ItemTouchHelper.Callback
{
    ...
    public SwipeController(Context aContext, SwipeControllerActions aSwipeControllerActions)
    {
        ...
        mReplyIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_chat_reply_24);
        mReplyIconBackground = ContextCompat.getDrawable(getContext(), R.drawable.ic_round_shape);
    }
    ...
    private void setTouchListener(RecyclerView recyclerView, final RecyclerView.ViewHolder viewHolder)
    {
        recyclerView.setOnTouchListener((v, event) ->
        {
            ...
            if (mSwipeBack){
                if (Math.abs(mView.getTranslationX()) >= convertToDp(120)){
